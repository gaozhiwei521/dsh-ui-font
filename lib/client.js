	...
	factory: (require) => {
		...
		function ensureStyle() {
			...
			styleEl.textContent =
				...
				"html[data-dsh-ui-font] body{font-family:var(--dsh-font-sans);-webkit-font-smoothing:var(--dsh-font-smooth);zoom:var(--dsh-font-zoom);}" +
				"html[data-dsh-ui-font] input,html[data-dsh-ui-font] textarea{font-family:var(--dsh-font-sans);}" +
		...
		function applyStyles(config) {
			...
			root.style.setProperty("--dsh-font-zoom", (config.zoom / 100).toFixed(3));
									...
									: (0, react_jsx_runtime.jsx)("div", {
										...
										children: shown.map((name) => (0, react_jsx_runtime.jsx)("div", {
											...
											children: [
												...
												(0, react_jsx_runtime.jsx)("div", { style: { ...styles.modalCardSample, fontFamily: '"' + name + '"' }, children: name + " — 中文字体 Aa 0123" })
											]
										}, name))
									})
						})
		...
		function FontRow({ t, setSans, setCode, setZoom, setLineHeight, setSmoothing, setLigatures, resetAll, useStore }) {
